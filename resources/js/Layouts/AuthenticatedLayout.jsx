...
export default function Authenticated({ user, header, actionBar, children }) {
        ...
        <div className="min-h-screen bg-gray-100">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink href={route('events.view')} active={route().current('events.view')}>
                                    Events
                                </NavLink>
                            </div>
            ...
            {header && (
                <header className="bg-white shadow">
                    <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-row flex-wrap items-center justify-between">
                        {header}
                        {actionBar}
                    </div>
                </header>
